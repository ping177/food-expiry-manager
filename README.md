...
v0.2.1 当前评估方向已从“国内商品条码 API”调整为“全球 / 欧洲 EAN 商品条码
API，优先覆盖德国进口猫罐头”。用户当前样本中，Go-UPC 对商品名和图片覆盖
最好，Barcode Lookup 适合作为第二 fallback，EAN-Search / EAN-Suche 适合做
相近商品建议；国内商品条码 API 当前样本表现较弱，暂不优先。
...
- 只有本地没有该 barcode 时，才查询 Open Food Facts / Open Pet Food Facts。
- 不使用条形码时可继续完全手动添加商品。
